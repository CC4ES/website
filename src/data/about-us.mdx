...
members:
  ...
  - name: Diana Ferreira
    ...
    bioText: |
      ...
      Diana is currently the Operations Associate at <b><em><a class="text-blue-500" href="https://www.nuestromundopcs.org">Nuestro Mundo Public Charter School</a></em></b> located in South Providence, RI. Nuestro Mundo is a dual language public charter school that also has a focus on teaching its students about Global Sustainability and to be stewards for the environment so that we may have a sustainable planet for many generations to come to which joining the Coalition Center for Environmental Sustainability was an easy decision because the CCES brings a wealth of knowledge and education that can only further catapult the impact she is trying to make in her community.
  ...
  - name: Grace Hamby
    ...
    image: "BioPic_Grace_Hamby(2).jpg"
    ...
    bioText: |
      ...
      Hamby is the CC4ES Youths for Sustainability, Y4US, Program Coordinator and a Teacher Assistant at <b><em><a class="text-blue-500" href="https://www.nuestromundopcs.org/">Nuestro Mundo Public Charter School</a></em></b> implementing garden-based programs.

  - name: Katie Cardamone, M.A.T.
    title: |
      CC4ES Collaborator
      Nuestro Mundo PCS, Co-Founder and Program Director
    image: "BioPic_Katie_Cardamone.jpg"
    image_alt: "Katie Cardamone picture"
    bioText: |
      Katie is an experienced elementary educator, working 15 years as an elementary Spanish immersion teacher. After graduating with her bachelor's and master's degrees from Clark University, she lived and worked in Guatemala. She previously was the Program Coordinator for the Multistate Association of Bilingual Education, Northeast (MABE) and now serves as the Co-Founder and Program Director at <b><em><a class="text-blue-500" href="https://www.nuestromundopcs.org/">Nuestro Mundo Public Charter School</a></em></b>. 

      Katie is passionate about the key outcome of a strong, innovative dual language program: empowering multilingual and multicultural learners to understand their importance as global citizens.
